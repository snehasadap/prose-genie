...
### Installation Instructions
  ...
  4. Install additional Hugging Face libraries for dataset handling and data collating
     ```sh
      ...
      ```
## Usage
Once installation is complete, you may proceed to copy my code from `newapp.py` and `essays.txt`. I placed the HTML script in `newapp.py`, so you won’t need an index.html file for this project. 

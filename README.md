...
### Additional Notes  
GPT-2 works by predicting the next word, given all the previous words within your input. In application, the coherence of the prosed text is dependent on the quality of your prompt. For better results, try structuring your prompt as a narrative rather than as a command. For example, instead of saying ***"Tell me about (topic),"*** you could start with ***"Today, I learned about (topic)."*** 
